...
import com.example.asus.jouyuejiache_dashixun1.bean.shouye_car_supper.ResultListBean;

import java.util.List;

public class CarSupper_ZuoAdapter extends BaseAdapter {
    private List<ResultListBean> resultList;
    private Context context;

    public CarSupper_ZuoAdapter(List<ResultListBean> mzuolist, Context context) {
        this.resultList = mzuolist;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        Shouye_YDSuperLVAdapter.ViewHolder holder=null;
        if(view==null){
            holder=new Shouye_YDSuperLVAdapter.ViewHolder();
            ...
            holder= (Shouye_YDSuperLVAdapter.ViewHolder) view.getTag();
        }
